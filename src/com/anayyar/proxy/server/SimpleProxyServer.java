package com.anayyar.proxy.server;
...
public static void main(String[] args) throws IOException {
 try {
   ...
   String host = "test.salesforce.com";
...
public static void runServer(String host, int remoteport, int localport) 
 ...
 while(true) { 
   ...
   try {
     ...
     try {
    	 Proxy proxy = new Proxy(Proxy.Type.HTTP, new InetSocketAddress("proxy.swglg01.local", 8080));
